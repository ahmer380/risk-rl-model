...
if __name__ == "__main__":
    ...
    agents = [RLAgent(risk_map, 2, "v2"), CommunistAgent()]
    simulation_runner = SimulationRunner("RLAgent vs Communist static player ordering", risk_map, agents, 100, observers=[OutcomeObserver(), BattleObserver()], shuffle_turn_order=True)
